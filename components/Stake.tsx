                    ...
                    <Box textAlign={"center"} mb={5}>
                        ...
                        <Skeleton isLoaded={!loadingStakeInfo && !loadingStakeTokenBalance}>
                            {stakeInfo && stakeInfo[0] ? (
                                <Text fontSize={"xl"} fontWeight={"bold"}>{ethers.utils.formatEther(stakeInfo[0])}{" " + stakeTokenBalance?.symbol}</Text>
                            ) : (
                                <Text>0</Text>
                            )}
                        </Skeleton>
                        ...
                        <Skeleton isLoaded={!loadingStakeInfo && !loadingRewardTokenBalance}>
                                {stakeInfo && stakeInfo[1] ? (
                                    <Box>
                                        ...
                                        <Text fontSize={"xl"} fontWeight={"bold"}>{" " + rewardTokenBalance?.symbol}</Text>
                                    </Box>
                                ) : (
                                    <Text>0</Text>
                                )}
